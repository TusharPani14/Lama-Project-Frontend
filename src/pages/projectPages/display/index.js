...
import noProjects from "../../../Assets/noProject.jpg";
...
const DisplayProjects = () => {
  ...
  const handleProjectPage = (projectName) => {
    navigate(`/project/upload/${projectName}`);
  };
    ...
    <div className={styles.container}>
      ...
      <div className={styles.productList}>
        {projects.length > 0 ? (
          projects.map((project, index) => (
            <div className={styles.products}>
              <div
                ...
                onClick={() => handleProjectPage(project.name)}
              >
          ...
          <img src={noProjects} alt=""  className={styles.img}/>
        )}
      </div>
    </div>
  );
